...
Semantic gives meaning to the HTML code we write. Semantic HTML tells the browsers exactly what it does and what content should go in it.
...
Git gives the opportunity to multiple persons to work on the same project in real-time. That is crucial when you have big projects with different types of codes.
